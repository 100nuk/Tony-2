...
#async def give_filter(client, message):
      #try:
         ...
         #lazy_chatIDx = await db.get_chat(int(chat))
         #if lazy_chatIDx[is_lazy_verified]:
            #await auto_filter(client, message)
      #except Exception as e:
            #ogger.error(f"Chat Not Verified: {e}")
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/movie_on1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    #Request verified
        ...
        try:
            ...
            btn = [
                  [
                  lnlinekeybordButton(text=f"Enable Chat", callback_data=f"enablelazychat:{chatTitle}:{chatID}")
              ],[
